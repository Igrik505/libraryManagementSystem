...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-12">
                <div class="buttons">
                    <div class="btn btn-success link-btn"><a href="{{'/createLend'}}">Видати книгу</a></div>
                ...
                <div class="card">
                    ...
                    <div class="card-header">{{ __('Книги на руках') }}</div>
                    ...
                    <div class="card-body scrollable">
                        ...
                        <table class="table table-striped">
                            ...
                            @foreach($lends as $lend)
                                <tr>
                                    <td>{{$lend->getReader->name}}</td>
                                    <td>{{$lend->getReader->phone}}</td>
                                    <td>{{$lend->getBook->name}}</td>
                                    <td>{{$lend->lendingEndDate}}</td>
                                    <td>
                                        <a class="btn btn-secondary" href="{{'/deleteLend/'.$lend->id}}">Видалити</a>
                                    </td>
                                </tr>
                            @endforeach
                            </tbody>
